        ...
        {toasts.map(toast => (
          <div
            ...
            className={`pointer-events-auto flex items-center justify-between p-4 rounded-xl shadow-lg border backdrop-blur-md transition-all duration-300 transform translate-y-0 ${
              toast.type === 'success'
                ? 'bg-emerald-950/90 border-emerald-600/40 text-white'
                : toast.type === 'error'
                ? 'bg-rose-950/90 border-rose-600/40 text-white'
                : toast.type === 'warning'
                ? 'bg-amber-950/90 border-amber-600/40 text-white'
                : 'bg-navy-900/95 border-brand-cyan/30 text-white'
            }`}
          >
